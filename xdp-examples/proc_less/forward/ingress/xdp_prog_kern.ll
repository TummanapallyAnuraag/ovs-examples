...
define i32 @xdp_pass_func(%struct.xdp_md* nocapture readnone) #0 section "xdp_pass" !dbg !41 {
  ...
  call void @llvm.dbg.value(metadata %struct.xdp_md* %0, metadata !56, metadata !DIExpression()), !dbg !60
  %3 = bitcast i32* %2 to i8*, !dbg !61
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3) #3, !dbg !61
  call void @llvm.dbg.value(metadata i32 0, metadata !57, metadata !DIExpression()), !dbg !62
  store i32 0, i32* %2, align 4, !dbg !62, !tbaa !63
  %4 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @counter to i8*), i8* nonnull %3) #3, !dbg !67
  %5 = bitcast i8* %4 to i32*, !dbg !67
  call void @llvm.dbg.value(metadata i32* %5, metadata !58, metadata !DIExpression()), !dbg !68
  %6 = icmp eq i8* %4, null, !dbg !69
  br i1 %6, label %10, label %7, !dbg !71

; <label>:7:                                      ; preds = %1
  %8 = load i32, i32* %5, align 4, !dbg !72, !tbaa !63
  %9 = add nsw i32 %8, 1, !dbg !72
  store i32 %9, i32* %5, align 4, !dbg !72, !tbaa !63
  br label %10, !dbg !74

; <label>:10:                                     ; preds = %1, %7
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3) #3, !dbg !75
  ret i32 1, !dbg !76
}
...
!1 = distinct !DIGlobalVariable(name: "counter", scope: !2, file: !3, line: 9, type: !27, isLocal: false, isDefinition: true)
...
!3 = !DIFile(filename: "xdp_prog_kern.c", directory: "/home/anuraag/mtp/proc_less/forward/ingress")
!4 = !{!5}
!5 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "xdp_action", file: !6, line: 2845, size: 32, elements: !7)
!6 = !DIFile(filename: "../includes/headers/linux/bpf.h", directory: "/home/anuraag/mtp/proc_less/forward/ingress")
!7 = !{!8, !9, !10, !11, !12}
...
!15 = distinct !DIGlobalVariable(name: "_license", scope: !2, file: !3, line: 30, type: !16, isLocal: false, isDefinition: true)
...
!22 = !DIFile(filename: "../includes/headers/bpf_helpers.h", directory: "/home/anuraag/mtp/proc_less/forward/ingress")
...
!41 = distinct !DISubprogram(name: "xdp_pass_func", scope: !3, file: !3, line: 18, type: !42, isLocal: false, isDefinition: true, scopeLine: 19, flags: DIFlagPrototyped, isOptimized: true, unit: !2, variables: !55)
...
!50 = !DIFile(filename: "/usr/include/asm-generic/int-ll64.h", directory: "/home/anuraag/mtp/proc_less/forward/ingress")
...
!55 = !{!56, !57, !58}
!56 = !DILocalVariable(name: "ctx", arg: 1, scope: !41, file: !3, line: 18, type: !45)
!57 = !DILocalVariable(name: "key", scope: !41, file: !3, line: 20, type: !44)
!58 = !DILocalVariable(name: "val", scope: !41, file: !3, line: 21, type: !59)
!59 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !44, size: 64)
!60 = !DILocation(line: 18, column: 35, scope: !41)
!61 = !DILocation(line: 20, column: 5, scope: !41)
!62 = !DILocation(line: 20, column: 9, scope: !41)
!63 = !{!64, !64, i64 0}
!64 = !{!"int", !65, i64 0}
!65 = !{!"omnipotent char", !66, i64 0}
!66 = !{!"Simple C/C++ TBAA"}
!67 = !DILocation(line: 23, column: 11, scope: !41)
!68 = !DILocation(line: 21, column: 10, scope: !41)
!69 = !DILocation(line: 24, column: 8, scope: !70)
!70 = distinct !DILexicalBlock(scope: !41, file: !3, line: 24, column: 8)
!71 = !DILocation(line: 24, column: 8, scope: !41)
!72 = !DILocation(line: 25, column: 15, scope: !73)
!73 = distinct !DILexicalBlock(scope: !70, file: !3, line: 24, column: 12)
!74 = !DILocation(line: 26, column: 5, scope: !73)
!75 = !DILocation(line: 28, column: 1, scope: !41)
!76 = !DILocation(line: 27, column: 5, scope: !41)
